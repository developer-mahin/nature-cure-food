      ...
      <LandingCartProvider>
        <LandingCartWrapper>
          ...
          <div className="min-h-screen font-hind">
            {/* Inline CSS Styles with scoped animations */}
            {extractedCSS && (
              <style
            ...
            {/* Page Content with Script Execution - Scoped to prevent interaction blocking */}
            <div
              className="relative"
              style={{ zIndex: 1 }}
            ...
            {/* Order Form Section with Product and Combo Selection - Higher z-index to ensure interactivity */}
